...
class Sharing_Admin {
	...
	public function sharing_head() {
		wp_enqueue_script( 'sharing-js', WP_SHARING_PLUGIN_URL.'js/admin-sharing.js', array( 'jquery-ui-draggable', 'jquery-ui-droppable', 'jquery-ui-sortable', 'jquery-form' ), 2 );
		wp_enqueue_style( 'sharing-admin', WP_SHARING_PLUGIN_URL.'css/admin-sharing.css', false, null );
		wp_enqueue_style( 'sharing', WP_SHARING_PLUGIN_URL.'css/sharing.css', false, null );
		wp_enqueue_script( 'sharing-js-fe', WP_SHARING_PLUGIN_URL . 'js/sharing.js', array( ), 3 );
